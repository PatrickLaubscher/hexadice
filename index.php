...
if(isset($_GET['game_name']) || isset($_GET['category']) || isset($_GET['player_nb']) || isset($_GET['age_mini'])) {
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-6 d-flex justify-content-around mb-4">
                    <a href="index.php?page=<?php echo $pagination->prevPage() ?>" class="col-2 d-flex justify-content-center align-items-center gap-2 btn btn-primary btn1">
                    ...
                    <?php $i = 1; while ($i <= $pagination->getTotalPage()) { ?>
                        <?php if($i == $pagination->getPageNb()) {?>
                            <p class="fw-bold nothing-serious-p"><?php echo $i?></p>
                        <?php } else { ?>
                        <a href="index.php?page=<?php echo $i?>" class="nothing-serious-p"><?php echo $i?></a>
                        <?php } ?>
                    <?php $i++; } ?>

                    <a href="index.php?page=<?php echo $pagination->nextPage() ?>" class="col-2 d-flex justify-content-center align-items-center gap-2 btn btn-primary btn1">
