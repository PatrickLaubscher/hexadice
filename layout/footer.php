                ...
                <div class="container p-4 pb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            <h2 class="text-uppercase fs-4">HEXADICE</h2>
                            <p>
                            ...
                            <a href="login_admin.php" class="text-white">
                        ...
                        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="#!" class="text-white">Nos jeux</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Autre</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                            <h5 class="text-uppercase">Contacter</h5>
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="#!" class="text-white">Par mail</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Où nous trouver?</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="#!" class="text-white">L'équipe</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Histoire d'Hexadice</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                            <h5 class="text-uppercase">Légal</h5>
                            <ul class="list-unstyled mb-0">
                                <li>
