    ...
    <div class="container">
        ...
        <ul class="navbar-nav">
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Accueil' ? 'active':''; ?>" href="index.php" title="Accueil">
            ...
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Contact' ? 'active':''; ?>" href="contact.php" title="">
            ...
            if(!isset($_SESSION['employee']) || !isset($_SESSION['customer'])) { ?>
                <a class="nav-link <?php echo $title== 'Login' ? 'active':''; ?>" href="login_customer.php" title="">
            ...
            <?php } ?>
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Panier' ? 'active':''; ?>" href="shopping_cart.php" title="">
            ...
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Backoffice' ? 'active':''; ?>" href="admin/admin.php" title="">
            ...
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Espace client' ? 'active':''; ?>" href="page_customer.php" title="">
            ...
            <li class="nav-item d-flex align-items-end">
            <a class="nav-link ms-2" href="process/session_stop.php" title="">
