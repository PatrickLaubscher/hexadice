    ...
    <div class="container">
        ...
        <ul class="navbar-nav">
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Accueil' ? 'active':''; ?> d-flex flex-column align-items-center" href="../index.php" title="">
            ...
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Backoffice' ? 'active':''; ?> d-flex flex-column align-items-center" href="admin.php" title="">
            ...
            <li class="nav-item d-flex align-items-end">
                <a class="nav-link <?php echo $title== 'Messagerie client' ? 'active':''; ?> d-flex flex-column align-items-center" href="customer_message.php" title="">
